...
# Verify necessary argument was passed
if [[ $# -eq 0 ]]; then
    echo "Interface name for StorageNetwork was not passed to $0"
    exit 1
fi

# Heat's {get_param: StorageNetwork..} can be passed as $1
OSD_NUMA_INTERFACE=$1
